...
> 原文:[https://www . geesforgeks . org/find _ element _ by _ link _ text-driver-method-selenium-python/](https://www.geeksforgeeks.org/find_element_by_link_text-driver-method-selenium-python/)
...
本文围绕如何使用 Selenium Web Driver 的定位策略抓取或定位网页中的元素展开。更具体地说，本文将讨论 find_element_by_link_text()。使用此策略，将返回链接文本值与位置匹配的第一个元素。如果没有元素具有匹配的链接文本属性，将引发 NoSuchElementException。
...
## 如何在 Selenium 中使用 driver . find _ element _ by _ link _ text()方法？

让我们尝试实际实现这个方法，并为**获取一个元素实例。让我们尝试使用其链接文本“教程”来抓取搜索表单输入。**
