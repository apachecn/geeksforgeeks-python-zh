...
> 原文:[https://www . geeksforgeeks . org/pafy-获取播放列表中每个项目的隐私/](https://www.geeksforgeeks.org/pafy-getting-privacy-for-each-item-of-playlist/)

在这篇文章中，我们将看到如何在 pafy 中获得播放列表每一项的隐私。Pafy 是一个 python 库，用于下载 YouTube 内容和检索元数据。Pafy 对象是包含给定视频所有信息的对象。YouTube 中的播放列表是按顺序播放的视频列表或组，一个视频接一个视频。基本上有三种隐私选择:公开、私人和未公开。
