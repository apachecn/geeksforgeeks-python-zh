...
> 原文:[https://www . geesforgeks . org/hotel-management-project-in-python/](https://www.geeksforgeeks.org/hotel-management-project-in-python/)

这个酒店管理项目是一个通用软件开发(使用 Python)，通过自动化酒店运营来简化酒店运营。在这个项目中，“AnCasa”是项目的酒店名称。它涵盖了酒店管理的主要方面；它可以执行以下操作-酒店预订，为您提供酒店房间信息，客房服务，计费和记录。

### 创建的函数

*   **Home()-** 功能显示项目的主屏幕，即项目的主页，也可以说是选择要执行的操作的主菜单。

*   **日期(str)—**功能验证用户/客户输入的日期。

*   **预订()-** 通过输入用户/客户详细信息在酒店预订房间的功能。

*   **Room_Info()-** 功能为用户/客户提供酒店房间信息(即关于房间设施的信息)。

*   **餐厅()-** 客房服务功能，为用户/顾客提供餐厅的菜单卡，以便在房间点餐。

*   **付款()-** 结账时生成酒店房间和餐厅账单的付款功能。
...
> —>4
> 金额:131 市
> 入住时间:2020 年 3 月 12 日
> 退房时间:2020 年 3 月 15 日
> 房间类型:3 床非空调
> 房间费用:13500
> 餐厅费用:0
> ———总房款:13500
...
> - > 5
> ***酒店记录***
> | 姓名|电话号码|地址|入住|退房|房型|价格|
> —————————————————————————————
> |乔根| 55552222 |城市 xyz 街 123 号| 2020 年 3 月 12 日| 2020 年 3 月 15 日| 3 床非 AC | 4500