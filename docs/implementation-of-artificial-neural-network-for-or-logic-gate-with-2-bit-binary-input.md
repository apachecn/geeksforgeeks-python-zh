...
> 原文:[https://www . geesforgeks . org/2 位二进制输入或逻辑门人工神经网络的实现/](https://www.geeksforgeeks.org/implementation-of-artificial-neural-network-for-or-logic-gate-with-2-bit-binary-input/)
...
**这里，根据真值表，每个测试输入的模型预测输出与或逻辑门常规输出(![$\boldsymbol{y}$](img/2a77d93c3050965e762fdc689edaab6e.png "Rendered by QuickLaTeX.com"))精确匹配，并且成本函数也持续收敛。
因此，它表示用于或逻辑门的人工神经网络被正确实现。**