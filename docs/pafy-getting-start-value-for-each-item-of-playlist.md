...
> 原文:[https://www . geesforgeks . org/pafy-获得播放列表中每个项目的起始值/](https://www.geeksforgeeks.org/pafy-getting-start-value-for-each-item-of-playlist/)

在本文中，我们将看到如何在 pafy 中获取播放列表中每一项的起始值。Pafy 是一个 python 库，用于下载 YouTube 内容和检索元数据。Pafy 对象是包含给定视频所有信息的对象。YouTube 中的播放列表是按顺序播放的视频列表或组，一个视频接一个视频。
